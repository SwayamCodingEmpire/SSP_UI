...
const BADGE_MAP: Record<string, { label: string; cssClass: string; pulse: boolean }> = {
  ...
  HUMAN_REVIEWED: { label: 'Reviewed',      cssClass: 'badge--orchid',  pulse: false },
  APPROVED:       { label: 'Approved',      cssClass: 'badge--sage',    pulse: false },
  FAILED:         { label: 'Failed',        cssClass: 'badge--crimson', pulse: false },
  PARSED:         { label: 'Parsed',        cssClass: 'badge--slate',   pulse: false },
  PROCESSED:      { label: 'Processed',     cssClass: 'badge--slate',   pulse: false },
